...
## 📖 Utilisation
1. Ouvrez `index.html` (ou le lien GitHub Pages) dans votre navigateur.
2. Sélectionnez un niveau de complexité en haut de l'écran.
3. Cliquez sur un accord pour voir sa composition, ses voisins harmoniques et les gammes suggérées.
4. Consultez l'aide intégrée **(?)** pour comprendre les concepts de la théorie Jazz (omission de la quinte).

---
**Développé par :** Daniel Ouimet  
**Date :** Janvier 2026
